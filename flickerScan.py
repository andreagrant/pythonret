...
#    print scanDict['numCycles']
#    print scanDict['period']
#    print scanDict['preScanRest']
#    print scanLength
    print scanDict
...
#    opPlotWrong=visual.ShapeStim(operatorWindow,units='pix',vertices=plotResp,closeShape=False,pos=(-448,-448),lineWidth=1,lineColor=[1,-1,-1],lineColorSpace='rgb' )
    ...
    #                                elementMask='circle')
    opPlot=visual.ElementArrayStim(operatorWindow,units='pix',xys=plotResp,sizes=7,nElements=plotMax,fieldPos=(-500,-384),
                                   colors=[1,1,1],colorSpace='rgb',sfs=0,fieldShape='square',
                                   elementMask='circle')
...
#    numpy.savetxt('chBb.txt',checkerBoardB[:,:,2],fmt='%f')
    ...
    stimA=visual.GratingStim(winSub,tex=checkerBoardA,size=imageSize,units='pix',texRes=imageSize)
...
#                plotResp=numpy.append(plotResp,[[respCounter,450]],0)
            ...
            plotLabel4.draw()
            opPlotGrid.draw()
            #plot ONLY if I have at least 3 responses
            if respCounter>3:            
                ...
                if plotStart<0:
                    plotStart=0
#                print plotResp
#                print plotResp[plotStart:respCounter,]
#                print plotResp.shape
                print plotStart                
                print respCounter
                foob=plotResp[plotStart:respCounter,]
                print foob.shape
                fakePlotResp[plotStart:respCounter,0]=plotResp[plotStart:respCounter,0]
                fakePlotResp[plotStart:respCounter,1]=plotResp[plotStart:respCounter,1]
                opPlot.setXYs(fakePlotResp)
